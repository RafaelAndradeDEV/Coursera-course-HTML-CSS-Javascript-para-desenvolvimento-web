...
O que acontece é o seguinte: quando o navegador pede uma página nova, ou atualiza uma sendo exibida — que para o servidor é como pedir uma página nova —, acontece uma requisição. O servidor web, ou servidor HTTP (no nosso caso, o Apache), recebe esta requisição e percebe que o arquivo solicitado tem a extensão .php . Quando isso acontece, o Apache primeiro manda o arquivo para o PHP para que este faça o processamento do arquivo. É nesta hora que o PHP preenche a página pegando a data e a hora do sistema operacional. Depois de processar tudo, o PHP devolve o resultado para o Apache, que, por sua vez, entrega uma resposta para o navegador.
