def computador_escolhe_jogada(n, m):
    ...
    while n != m + i:
        i = i + 1
        if i % 2 == 0 and m % 2 == 0: #m é par e i é par
            variavel2 = 1
        if i % 2 == 1 and m % 2 == 0: #m é par e i é impar
            variavel2 = 2
        if i % 2 == 1 and m % 2 == 1: #m é impar e i é impar
            variavel2 = 2
        if i % 2 == 0 and m % 2 == 1: #m é impar e i é par
            variavel2 = 1
    #if n > h and n <= m * 2: h = m + i i = i + 1 variavel2 = i
    if n <= m:
        variavel2 = n
    n = n - variavel2
    if n == 0:
